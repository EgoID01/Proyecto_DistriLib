...
def estadistico():
    ...
    # Ventas mensuales del año actual (solo ACTIVA)
    ...
    # Top 5 libros más vendidos (por cantidad, ventas ACTIVA)
...
def reporte_ventas():
    ...
    vendedores = Usuario.query.filter_by(activo=True).order_by(Usuario.nombres).all()
